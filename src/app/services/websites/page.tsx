...
import { Code2, Compass, Cpu, Gauge, Shield, Sparkles } from 'lucide-react';
        ...
        <div className="narrow">
          ...
          <div className="text-center mb-20 relative z-10">
            ...
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-white mb-6" style={{ fontFamily: 'var(--display)', letterSpacing: '-0.04em' }}>
              ...
              }} className="italic font-light">strategy.</span>
            </h1>
          ...
          <div className="bg-[#0b0c10]/40 border border-white/5 backdrop-blur-xl p-8 md:p-12 rounded-3xl mb-20 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex gap-4">
                <div className="text-[#38bdf8] shrink-0"><Code2 className="w-6 h-6" /></div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="text-[#38bdf8] shrink-0"><Shield className="w-6 h-6" /></div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="text-[#38bdf8] shrink-0"><Cpu className="w-6 h-6" /></div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="text-[#38bdf8] shrink-0"><Gauge className="w-6 h-6" /></div>
                <div>
